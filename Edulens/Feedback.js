...
export default function Feedback() {
  return (
    <div>
       <div class="bgimg">
       <img src="https://img.freepik.com/premium-vector/seamless-science-pattern-hand-drawn-science-doodles-blue_125371-89.jpg?w=2000"  height="860px" width="1536px"></img>
       </div>
       ...
       <div class="form666">
          <form onSubmit>
              ...
              <br/>
              <br/>
              <input type="text666" name="better"/>
              <br/>
              <br/>
